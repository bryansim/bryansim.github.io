...
BLOG_AUTHOR = "Bryan Sim"  # (translatable)
BLOG_TITLE = "Bryan Sim"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://bryansim.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://bryansim.github.io/"
BLOG_EMAIL = "bryan.sim@nyu.edu"
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        #("/stories/hello", "About"),
        ("/categories/mediocre-museum", "Mediocre Museum"),
        ("/categories/mousetracker", "Mousetracker"),
        ("/categories/skytrax", "Skytrax"),
        ("/archive.html", "Archive"),
        ("http://linkedin.com/in/bryansim", "LinkedIn"),
   ),
}
...
FRONT_INDEX_HEADER = {
    DEFAULT_LANG: '''<article class="storypage" itemscope="itemscope" itemtype="http://schema.org/Article"><header><h1 class="p-name entry-title" itemprop="headline name">Hello!</h1>
    ...
    <div>
<p>I'm Bryan. 
This is my blog of the following projects (links above):</p>
<h3>Mediocre Museum</h3>
<p>The mediocre part of this project comes from my friend Emilia's and my goal of building the most average artifact possible. We're currently working with open data obtained from the Canada Science and Technology Museums Corporation, obtainable <a href="http://techno-science.ca/en/data.php">here</a>.</p>
<h3>Mousetracker Data</h3>
<p>I'm working with my colleagues, Qi Xu and Carlina Conrad, at the <a href="http://www.psych.nyu.edu/couples/">NYU Couples Lab</a> to learn more about how people in relationships allocate resources amongsts themselves, and balance self-, altruistic, and group interests.</p>
<h3>Skytrax Ratings</h3>
<p>What makes a good flight? Using Skytrax ratings data scraped by <a href="https://github.com/quankiquanki/skytrax-reviews-dataset/tree/master/data">Quang Nguyen</a>, I'm investigating what factors make up a passenger's overall rating, as well as what influences their decision to recommend an airline to others (vs. not).</p>
</div>
    </div>
...
FAVICONS = (
     ("icon", "http://bryans.im/favicon.ico", "16x16"),
...
# Atom feeds are built based on DISPLAY_POST_COUNT and not FEED_LENGTH
